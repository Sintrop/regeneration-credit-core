...
export function ContributionCertificateShort({
  address,
  url,
  showDownload,
  certificateTokens
  ...
  async function handleDownload(): Promise<void> {
    const certificate = document.getElementById('contribution-certificate-short')
    if (!certificate) return

    htmlToImage
      .toPng(certificate)
      .then((dataUrl) => download(dataUrl, 'contribution-certificate-short'))
  }
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div
        id="contribution-certificate-short"
