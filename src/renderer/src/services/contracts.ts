...
export const sequoiaUserAddress = import.meta.env.VITE_SEQUOIA_USER_ADDRESS
...
export const sequoiaResearcherPoolAddress = import.meta.env.VITE_SEQUOIA_RSEARCHER_POOL_ADDRESS
...
export const sequoiaContributorPoolAddress = import.meta.env.VITE_SEQUOIA_CONSTRIBUTOR_POOL_ADDRESS
...
export const userAddress = import.meta.env.VITE_USER_ADDRESS
...
export const researcherPoolAddress = import.meta.env.VITE_RSEARCHER_POOL_ADDRESS
...
export const contributorPoolAddress = import.meta.env.VITE_CONSTRIBUTOR_POOL_ADDRESS
